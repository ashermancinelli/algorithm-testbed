...
macro(add_cobol_example)
  ...
  set(SVARGS NAME)
  set(MVARGS SOURCES)
  cmake_parse_arguments(ADD_COBOL_EXAMPLE
    "${OPTIONS}"
    "${SVARGS}"
    "${MVARGS}"
    ${ARGN}
  ...
  list(
    TRANSFORM ADD_COBOL_EXAMPLE_SOURCES
    PREPEND "${CMAKE_CURRENT_SOURCE_DIR}/"
    )

  add_custom_target(${ADD_COBOL_EXAMPLE_NAME} ALL
  ...
  add_custom_command(
    ...
    COMMAND
    ${COBC_EXE} -x ${ADD_COBOL_EXAMPLE_SOURCES}
    -o ${CMAKE_CURRENT_BINARY_DIR}/${ADD_COBOL_EXAMPLE_NAME}
    )
endmacro()
