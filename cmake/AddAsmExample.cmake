macro(add_asm_example)
  ...
  cmake_parse_arguments(
    ADD_ASM_EXAMPLE "${OPTIONS}" "${SVARGS}" "${MVARGS}" ${ARGN}
  )
  ...
  add_custom_command(
    ...
    COMMAND ${CMAKE_C_COMPILER} ${ADD_ASM_EXAMPLE_SOURCES} -o
            "${CMAKE_CURRENT_BINARY_DIR}/${ADD_ASM_EXAMPLE_NAME}"
  )

  add_custom_target(
    ${ADD_ASM_EXAMPLE_NAME} ALL
