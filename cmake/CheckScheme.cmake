...
macro(add_scheme_executable)
  ...
  set(SVARGS NAME)
  set(MVARGS SOURCES)
  cmake_parse_arguments(ADD_SCHEME_EXECUTABLE
    "${OPTIONS}"
    "${SVARGS}"
    "${MVARGS}"
    ${ARGN}
  ...
  list(
    TRANSFORM ADD_SCHEME_EXECUTABLE_SOURCES
    PREPEND "${CMAKE_CURRENT_SOURCE_DIR}/"
    )

  add_custom_target(${ADD_SCHEME_EXECUTABLE_NAME} ALL
  ...
  add_custom_command(
    ...
    COMMAND
    ${SCHEME_EXE} ${ADD_SCHEME_EXECUTABLE_SOURCES}
    -x ${CMAKE_CURRENT_BINARY_DIR}/${ADD_SCHEME_EXECUTABLE_NAME}
    )
endmacro()
